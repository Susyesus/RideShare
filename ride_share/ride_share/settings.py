...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'dashboard_app.context_processors.notifications',
                'dashboard_app.context_processors.user_profile_picture',
            ],
        },
    },
]
...
DEFAULT_FROM_EMAIL = "auditormechole@gmail.com"  # your verified single sender
